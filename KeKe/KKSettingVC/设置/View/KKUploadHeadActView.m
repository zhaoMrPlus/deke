...
@implementation KKUploadHeadActView
-(NSMutableArray *)datasourceData{
    
    if (_datasourceData == nil) {
        _datasourceData =[NSMutableArray arrayWithObjects:@"相机",@"相册",@"取消", nil];
    }
...
-(void)remove{
    [UIView animateWithDuration:0.25 animations:^{
        table.frame = CGRectMake(0, self.frame.size.height, self.frame.size.width, 150);
