...
- (void)loadVideoTrimmerView {
    ...
    ICGVideoTrimmerView *trimmerView = [[ICGVideoTrimmerView alloc] initWithFrame:CGRectMake(0, self.frame.size.height - kVideoTrimmerViewHeight - 21, self.frame.size.width, kVideoTrimmerViewHeight) asset:asset];
